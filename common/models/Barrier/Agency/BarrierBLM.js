...
module.exports = function (BarrierBLM) {
  const testQuery = require("../../../javascripts/query.js");

  BarrierBLM.barrierBLMGeoJSON = function (query, cb) {
    const dataSource = BarrierBLM.app.datasources.mip;
    const sql = testQuery.barrier_blm_query;
