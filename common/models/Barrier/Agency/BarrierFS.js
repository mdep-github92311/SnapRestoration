...
module.exports = function (BarrierFS) {
  const testQuery = require("../../../javascripts/query.js");

  BarrierFS.barrierFSGeoJSON = function (query, cb) {
    const dataSource = BarrierFS.app.datasources.mip;
    const sql = testQuery.barrier_fs_query;
