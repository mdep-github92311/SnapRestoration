...
module.exports = function (BarrierFWS) {
  const testQuery = require("../../../javascripts/query.js");

  BarrierFWS.barrierFWSGeoJSON = function (query, cb) {
    const dataSource = BarrierFWS.app.datasources.mip;
    const sql = testQuery.barrier_fws_query;
