...
module.exports = function (BarrierNPS) {
  const testQuery = require("../../../javascripts/query.js");

  BarrierNPS.barrierNPSGeoJSON = function (query, cb) {
    const dataSource = BarrierNPS.app.datasources.mip;
    const sql = testQuery.barrier_nps_query;
