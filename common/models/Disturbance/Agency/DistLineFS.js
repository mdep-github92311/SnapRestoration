...
module.exports = function (DistLineFS) {
  const testQuery = require("../../../javascripts/query.js");

  DistLineFS.distLineFSGeoJSON = function (query, cb) {
    const dataSource = DistLineFS.app.datasources.mip;
    const sql = testQuery.dist_line_fs_query;
