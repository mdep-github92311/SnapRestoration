...
module.exports = function (DistLineFWS) {
  const testQuery = require("../../../javascripts/query.js");

  DistLineFWS.distLineFWSGeoJSON = function (query, cb) {
    const dataSource = DistLineFWS.app.datasources.mip;
    const sql = testQuery.dist_line_fws_query;
