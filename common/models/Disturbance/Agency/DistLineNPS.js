...
module.exports = function (DistLineNPS) {
  const testQuery = require("../../../javascripts/query.js");

  DistLineNPS.distLineNPSGeoJSON = function (query, cb) {
    const dataSource = DistLineNPS.app.datasources.mip;
    const sql = testQuery.dist_line_nps_query;
