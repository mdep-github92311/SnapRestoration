...
module.exports = function (DistPointBLM) {
  const testQuery = require("../../../javascripts/query.js");

  DistPointBLM.distPointBLMGeoJSON = function (query, cb) {
    const dataSource = DistPointBLM.app.datasources.mip;
    const sql = testQuery.dist_point_blm_query;
