...
module.exports = function (DistPointFS) {
  const testQuery = require("../../../javascripts/query.js");

  DistPointFS.distPointFSGeoJSON = function (query, cb) {
    const dataSource = DistPointFS.app.datasources.mip;
    const sql = testQuery.dist_point_fs_query;
