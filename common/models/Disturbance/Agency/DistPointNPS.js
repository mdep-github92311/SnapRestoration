...
module.exports = function (DistPointNPS) {
  const testQuery = require("../../../javascripts/query.js");

  DistPointNPS.distPointNPSGeoJSON = function (query, cb) {
    const dataSource = DistPointNPS.app.datasources.mip;
    const sql = testQuery.dist_point_nps_query;
