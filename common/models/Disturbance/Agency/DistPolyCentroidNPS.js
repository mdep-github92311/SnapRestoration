...
module.exports = function (DistPolyCentroidNPS) {
  const testQuery = require("../../../javascripts/query.js");

  DistPolyCentroidNPS.distPolyCentNPSGeoJSON = function (query, cb) {
    const dataSource = DistPolyCentroidNPS.app.datasources.mip;
    const sql = testQuery.dist_poly_centroid_nps_query;
  ...
  DistPolyCentroidNPS.remoteMethod(
    'distPolyCentNPSGeoJSON',
    {
      http: {verb: 'get'},
