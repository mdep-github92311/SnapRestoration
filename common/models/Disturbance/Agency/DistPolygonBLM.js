...
module.exports = function (DistPolygonBLM) {
  const testQuery = require("../../../javascripts/query.js");

  DistPolygonBLM.distPolyBLMGeoJSON = function (query, cb) {
    const dataSource = DistPolygonBLM.app.datasources.mip;
    const sql = testQuery.dist_poly_blm_query;
