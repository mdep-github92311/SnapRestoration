...
module.exports = function (DistPolygonFS) {
  const testQuery = require("../../../javascripts/query.js");

  DistPolygonFS.distPolyFSGeoJSON = function (query, cb) {
    const dataSource = DistPolygonFS.app.datasources.mip;
    const sql = testQuery.dist_poly_fs_query;
