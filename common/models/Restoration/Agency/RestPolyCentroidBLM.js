...
module.exports = function (RestPolyCentroidBLM) {
  const testQuery = require("../../../javascripts/query.js");

  RestPolyCentroidBLM.restoPolyCentBLMGeoJSON = function (query, cb) {
    const dataSource = RestPolyCentroidBLM.app.datasources.mip;
    const sql = testQuery.resto_poly_centroid_fs_query;
  ...
  RestPolyCentroidBLM.remoteMethod(
    'restoPolyCentBLMGeoJSON',
    {
      http: {verb: 'get'},
