...
module.exports = function (RestPolyCentroidFS) {
  const testQuery = require("../../../javascripts/query.js");

  RestPolyCentroidFS.restoPolyCentFSGeoJSON = function (query, cb) {
    const dataSource = RestPolyCentroidFS.app.datasources.mip;
  ...
  RestPolyCentroidFS.remoteMethod(
    'restoPolyCentFSGeoJSON',
    {
      http: {verb: 'get'},
