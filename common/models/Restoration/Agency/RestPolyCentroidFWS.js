...
module.exports = function (RestPolyCentroidFWS) {
  const testQuery = require("../../../javascripts/query.js");

  RestPolyCentroidFWS.restoPolyCentFWSGeoJSON = function (query, cb) {
    const dataSource = RestPolyCentroidFWS.app.datasources.mip;
    const sql = testQuery.resto_poly_centroid_fws_query;
  ...
  RestPolyCentroidFWS.remoteMethod(
    'restoPolyCentFWSGeoJSON',
    {
      http: {verb: 'get'},
