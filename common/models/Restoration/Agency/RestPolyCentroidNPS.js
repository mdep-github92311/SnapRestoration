...
module.exports = function (RestPolyCentroidNPS) {
  const testQuery = require("../../../javascripts/query.js");

  RestPolyCentroidNPS.restoPolyCentNPSGeoJSON = function (query, cb) {
    const dataSource = RestPolyCentroidNPS.app.datasources.mip;
    const sql = testQuery.resto_poly_centroid_nps_query;
  ...
  RestPolyCentroidNPS.remoteMethod(
    'restoPolyCentNPSGeoJSON',
    {
      http: {verb: 'get'},
