...
module.exports = function (RestoLineBLM) {
  const testQuery = require("../../../javascripts/query.js");

  RestoLineBLM.restoLineBLMGeoJSON = function (query, cb) {
    const dataSource = RestoLineBLM.app.datasources.mip;
    const sql = testQuery.resto_line_blm_query;
