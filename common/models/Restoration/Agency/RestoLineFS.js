...
module.exports = function (RestoLineFS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoLineFS.restoLineFSGeoJSON = function (query, cb) {
    const dataSource = RestoLineFS.app.datasources.mip;
    const sql = testQuery.resto_line_fs_query;
