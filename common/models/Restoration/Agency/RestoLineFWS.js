...
module.exports = function (RestoLineFWS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoLineFWS.restoLineFWSGeoJSON = function (query, cb) {
    const dataSource = RestoLineFWS.app.datasources.mip;
    const sql = testQuery.resto_line_fws_query;
