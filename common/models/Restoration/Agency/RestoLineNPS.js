...
module.exports = function (RestoLineNPS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoLineNPS.restoLineNPSGeoJSON = function (query, cb) {
    const dataSource = RestoLineNPS.app.datasources.mip;
    const sql = testQuery.resto_line_nps_query;
