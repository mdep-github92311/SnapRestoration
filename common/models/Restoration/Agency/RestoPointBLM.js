...
module.exports = function (RestoPointBLM) {
  const testQuery = require("../../../javascripts/query.js");

  RestoPointBLM.restoPointBLMGeoJSON = function (query, cb) {
    const dataSource = RestoPointBLM.app.datasources.mip;
    const sql = testQuery.restoPoint_blm_query;
  ...
  RestoPointBLM.remoteMethod(
    'restoPointBLMGeoJSON',
    {
      http: {verb: 'get'},
