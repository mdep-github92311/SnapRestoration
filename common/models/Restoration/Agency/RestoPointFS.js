...
module.exports = function (RestoPointFS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoPointFS.restoPointFSGeoJSON = function (query, cb) {
    const dataSource = RestoPointFS.app.datasources.mip;
    const sql = testQuery.restoPoint_fs_query;
