...
module.exports = function (RestoPointFWS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoPointFWS.restoPointFWSGeoJSON = function (query, cb) {
    const dataSource = RestoPointFWS.app.datasources.mip;
    const sql = testQuery.restoPoint_fws_query;
  ...
  RestoPointFWS.remoteMethod(
    'restoPointFWSGeoJSON',
    {
      http: {verb: 'get'},
