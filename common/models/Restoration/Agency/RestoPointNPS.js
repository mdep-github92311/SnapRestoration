...
module.exports = function (RestoPointNPS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoPointNPS.restoPointNPSGeoJSON = function (query, cb) {
    const dataSource = RestoPointNPS.app.datasources.mip;
    const sql = testQuery.restoPoint_nps_query;
  ...
  RestoPointNPS.remoteMethod(
    'restoPointNPSGeoJSON',
    {
      http: {verb: 'get'},
