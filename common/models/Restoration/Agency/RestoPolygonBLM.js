...
module.exports = function (RestoPolygonBLM) {
  const testQuery = require("../../../javascripts/query.js");

  RestoPolygonBLM.restoPolyBLMGeoJSON = function (query, cb) {
    const dataSource = RestoPolygonBLM.app.datasources.mip;
    const sql = testQuery.resto_poly_blm_query;
