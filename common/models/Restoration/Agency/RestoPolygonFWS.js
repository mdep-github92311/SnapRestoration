...
module.exports = function (RestoPolygonFWS) {
  const testQuery = require("../../../javascripts/query.js");

  RestoPolygonFWS.restoPolyFWSGeoJSON = function (query, cb) {
    const dataSource = RestoPolygonFWS.app.datasources.mip;
    const sql = testQuery.resto_poly_fws_query;
