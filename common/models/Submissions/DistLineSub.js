...
module.exports = function (DistLineSub) {
  const testQuery = require("../../javascripts/query.js");

  DistLineSub.distLineSubGeoJSON = function (query, cb) {
    const dataSource = DistLineSub.app.datasources.mip;
    const sql = testQuery.dist_line_sub_query;
