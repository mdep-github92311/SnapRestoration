...
module.exports = function (DistPointSub) {
  const testQuery = require("../../javascripts/query.js");

  DistPointSub.distPointSubGeoJSON = function (query, cb) {
    const dataSource = DistPointSub.app.datasources.mip;
    const sql = testQuery.dist_point_sub_query;
