...
module.exports = function (DistPolygonSub) {
  const testQuery = require("../../javascripts/query.js");

  DistPolygonSub.distPolySubGeoJSON = function (query, cb) {
    const dataSource = DistPolygonSub.app.datasources.mip;
    const sql = testQuery.dist_poly_sub_query;
