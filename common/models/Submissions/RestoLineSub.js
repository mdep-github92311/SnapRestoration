...
module.exports = function (RestoLineSub) {
  const testQuery = require("../../javascripts/query.js");

  RestoLineSub.restoLineSubGeoJSON = function (query, cb) {
    const dataSource = RestoLineSub.app.datasources.mip;
    const sql = testQuery.resto_line_sub_query;
