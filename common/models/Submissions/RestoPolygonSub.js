...
module.exports = function (RestoPolygonSub) {
  const testQuery = require("../../javascripts/query.js");

  RestoPolygonSub.restoPolySubGeoJSON = function (query, cb) {
    const dataSource = RestoPolygonSub.app.datasources.mip;
    const sql = testQuery.resto_poly_sub_query;
