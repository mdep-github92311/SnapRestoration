...
! function(t, e, i) {
    ...
    o.Marker.include(a), o.Circle.include(a), o.CircleMarker.include(a), o.Polyline.prototype.toGeoJSON = function() {
        ...
        _createRadioElement: function(t, i) {
            ...
            var n = '<label class="switch"><input type="checkbox" class="leaflet-control-layers-selector" name="' + t + '"' + (i ? ' checked="checked"' : "") + "><span class='slider round'></span></label>",
        ...
        _addItem: function(t) {
            ...
            t.overlay = (i = ('<label class="switch"><input type="checkbox" class="leaflet-control-layers-selector" name="' + t + '"' + (i ? ' checked="checked"' : "") + ">hgjhgjhgjh<span class='slider round'></span></label>"), i.layerId = o.stamp(t.layer), o.DomEvent.on(i, "click", this._onInputClick, this));
