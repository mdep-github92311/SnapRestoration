      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 34:
            ...
            _context2.t11 = dbCache.blmRegion.count(function (records) {
              if (records > 0) {
            ...
            _context2.t12 = dbCache.fsRegion.count(function (records) {
              if (records > 0) {
            ...
            _context2.t13 = dbCache.mdepBound.count(function (records) {
              if (records > 0) {
            ...
            _context2.t14 = dbCache.mdiBound.count(function (records) {
              if (records > 0) {
            ...
            _context2.t15 = dbCache.nvCounties.count(function (records) {
              if (records > 0) {
          ...
          case 46:
            _context2.prev = 46;
            _context2.t17 = _context2["catch"](11);
