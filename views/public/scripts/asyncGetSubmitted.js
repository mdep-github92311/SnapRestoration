...
try {
    $.when(
      ...
      await $.getJSON('http://216.117.167.186/api/BarrierSubs/barrierSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://216.117.167.186/api/DistPointSubs/distPointSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://216.117.167.186/api/DistLineSubs/distLineSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://216.117.167.186/api/DistPolygonSubs/distPolySubGeoJSON', function (data) {
      ...
      await $.getJSON('http://216.117.167.186/api/RestoPointSubs/restoPointSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://216.117.167.186/api/RestoLineSubs/restoLineSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://216.117.167.186/api/RestoPolygonSubs/restoPolySubGeoJSON', function (data) {
