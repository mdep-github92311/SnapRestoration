...
try {
    $.when(
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/BarrierSubs/barrierSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/DistPointSubs/distPointSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/DistLineSubs/distLineSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/DistPolygonSubs/distPolySubGeoJSON', function (data) {
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/RestoPointSubs/restoPointSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/RestoLineSubs/restoLineSubGeoJSON', function (data) {
      ...
      await $.getJSON('http://' + ipAddress1 + '/api/RestoPolygonSubs/restoPolySubGeoJSON', function (data) {
