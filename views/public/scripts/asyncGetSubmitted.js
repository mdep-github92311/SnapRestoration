...
try {
  ...
  //$.getJSON('http://216.117.167.186/api/DistPointSubs/distPointSubGeoJSON', function (data) {
  ...
  //$.getJSON('http://216.117.167.186/api/DistPointSubs/distPointSubGeoJSON', function (data) {
  await $.getJSON('http://snap-restoration-brstillwell.c9users.io/api/DistLineSubs/distLineSubGeoJSON', function (data) {
    distLines = data[0].row_to_json;
    console.log(distLines.features);
