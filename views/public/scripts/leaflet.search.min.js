$(document).ready(function () {
  ...
  function createFilteredList(featureList){
    ...
    for (var index in featureList){
      ...
      var row = $("<tr>", {value: index}).append($("<td>", {text: props.gid, rowspan: 2}))
      ...
      var row2 = $("<tr>", {value: index}).append($("<td>", {colspan: 3, text: "Observer: " + props.primary_ob}))
                                          .append($("<td>", {colspan: 2, text: "Date: " + props.gps_date}))
      row.click(function(e){
         featureList[e.currentTarget.attributes[0].value].fireEvent('click'); 
       })
      $("#filteredFeatures").append(row).append(row2);
    }
  }
