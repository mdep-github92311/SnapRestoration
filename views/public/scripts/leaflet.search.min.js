$(document).ready(function () {
  ...
  function createFilteredList(featureList){
    ...
    for (var index in featureList){
      $("#filteredFeatures").append("<tr><td>"+getAgencyName(featureList[index].feature.properties.agency)+"</td><td>"+featureList[index].feature.properties.region+"</td><td><button id='viewFiltered"+index+"' value='"+index+"' class='btn btn-default'>View</button></td></tr>");
